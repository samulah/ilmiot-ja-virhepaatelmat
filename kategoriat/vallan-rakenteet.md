...
**Siirrä sitä, mitä voi ajatella.** [Overton-ikkuna](overton-ikkuna.html) kuvaa kaistaa, jolla liikkuvia ideoita pidetään kulloinkin hyväksyttävinä. Sitä ei tarvitse siirtää argumenteilla — riittää, että ääripäätä esitetään toistuvasti, jolloin aiemmin äärimmäinen alkaa vaikuttaa maltilliselta. Kun ikkuna on siirtynyt, muutosta ei tarvitse enää perustella.

**Ota haltuun se, joka valvoo.** [Sääntelijän kaappaus](saantelijan-kaappaus.html) on tämän hienovaraisin muoto: valvottava toimiala päätyy vähitellen määrittelemään, mitä valvotaan ja miten. Se ei vaadi lahjontaa, vaan riittää että alan ainoat todelliset asiantuntijat työskentelevät alalla. [Rautainen laki oligarkiasta](rautainen-laki.html) yleistää saman jokaiseen organisaatioon: myös demokraattiseksi tarkoitettu järjestö ajautuu pienen sisäpiirin hallintaan, koska jatkuvuus, osaaminen ja verkostot kasautuvat niille, jotka jo ovat sisällä. [Valta suojelee valtaa](valta-suojelee-valtaa.html) on lopputulos — sama taho asettaa säännöt, valitsee tuomarit ja määrittelee, mikä on laillista.
...
1. **Katso suuntaa, älä yksittäistä päätöstä.** Jokainen askel on erikseen perusteltavissa. Kysy, mihin sarja on viemässä.
2. **Kysy, kuka määritteli kysymyksen.** Jos keskustelu käydään ”kuinka paljon leikataan” -asetelmassa, päätös leikkaamisesta on jo tehty.
3. **Etsi valvojan ja valvottavan CV:t.** Sääntelijän kaappaus näkyy henkilöhistorioissa aiemmin kuin päätöksissä.
4. **Epäile riitaa, joka hyödyttää kolmatta.** Kysy, kuka hyötyy siitä, että te kaksi olette eri mieltä.

:::html
<div class="infolaatikko">
<h2 class="laatikko-otsikko">Yhteinen tunnusmerkki:</h2> nämä mekanismit toimivat hitaudellaan. Yksikään ei vaadi salaliittoa eikä yhtäkään yksittäistä päätöstä, jota ei voisi puolustaa julkisesti. Juuri siksi ne ovat tehokkaita — ja siksi ainoa toimiva vastakeino on katsoa riittävän pitkää aikaväliä kerralla.
</div>
:::
